...
class Skills extends React.Component {
  constructor(props) {
    ...
    this.state = {
      message:
        "I enjoy working on websites.designing,implementing apis and working on backend.I have designed few frontend designs and implemented api with react.I also have worked ecomerce website to build a fullly functional backend project with django.Check out my github page",
      stateOne: true,
      states: [
        { stateOne: true },
        { stateTwo: false },
  ...
  toggleTwo = () => {
    this.setState({
      image: false,
      message:
        "Flutter was amazing choice i made. it was the best framework i used for building apps.I built few flutter apps like youtube channel api , restuarant app and few front designs.Check out my github page",
    });
    this.setState({
      stateTwo: true,
      stateOne: false,
  ...
  toggleThree = () => {
    this.setState({
      image: false,
      message:
        "I am an artist so i like designing ui/ux for website and apps.Check out my github page",
    });
    this.setState({
      StateThree: true,
      stateOne: false,
